...
Brings up a Prometheus, Grafana, and Alertmanager development stack quickly using Docker.
  ...
  - Stack config files are stored in `./configs` directory.
  - The `./docker` directory contains files and scripts for building the docker images. You do not need to edit these.
  - The `./scripts` directory contains scripts used by `make` commands. They are not inteded to be run directly.
...
make build
make up
vi configs/prometheus/prometheus.yml # edit as desired
make reload # to load new configs in the running container
make help
```
...
| 9132 | [EdgeMAX exporter (deprecated)](https://github.com/mdlayher/edgemax_exporter) |
...
| 9679 | [AWS Health Exporter (WIP)](https://github.com/vladvasiliu/aws-health-exporter-rs) |
...
| 9682 | [Powder Monkey](https://github.com/sapcc/powder-monkey) (WIP) |
...
| 9685 | [Eideticom](http://www.eideticom.com) NoLoad Metric Exporter (WIP) |
...
| 9692 | [GCP GCE Exporter](https://github.com/0x0I/gcp-gce-exporter) (WIP) |
...
| 9695 | [CIFS Exporter](https://github.com/shibumi/cifs-exporter) (WIP) |
| 9696 | [Jitsi Videobridge Exporter](https://github.com/slrz/jvb-exporter) (WIP) |
| 9697 | [Tendermint Blockchain Exporter](https://github.com/dmitry-ee/tendermint-prometheus-exporter) |
| 9698 | [Integrated Dell Remote Access Controller (iDRAC) Exporter](https://github.com/greenpau/idrac_exporter) (WIP) |
| 9699 | [Pyncette Exporter](https://github.com/tibordp/pyncette/blob/master/src/pyncette/prometheus.py) (WIP)
...
| 9703 | [Vircadia](https://github.com/kasenvr/project-athena) (WIP) |
| 9704 | [Linux TC exporter](https://github.com/fbegyn/tc_exporter) (WIP) |
...
| 9709 | [Lidarr exporter (WIP)](https://github.com/onedr0p) |
| 9710 | NIC saturation exporter [(WIP)](https://github.com/cdanis) |
...
| 9717 | [TPLink EasySmart Switch Exporter](https://github.com/thelastguardian/tplinkexporter) (WIP) | 
| 9718 | [Warp10 Exporter](https://github.com/centreon/warp10-sensision-exporter) | 
| 9719 | [Pgpool-II Exporter](https://github.com/pengbo0328/pgpool2_exporter) (WIP) | 
| 9720 | [Moodle DB Exporter](https://github.com/debugloop/moodledb_exporter) | 
| 9721 | StorageOS (WIP) |
| 9722 | [Miele Exporter](https://github.com/gebn/miele_exporter) (WIP) |
| 9723 | Akamai GTM RTS Exporter (WIP) |
